    ...
    return (
      <div className="twitterModal">
        <div className="twitterModal-content">
          <h2>Share this product</h2>
          <a
            href="https://twitter.com/share?url=example.org&text=Check%20this%20out!"
            target="_blank">
            Share on Twitter
          </a>
    ...
    return (
      <div className="pinterestModal">
        <div className="pinterestModal-content">
          <h2>Share this product</h2>
          <a
            href="http://pinterest.com/pin/create/button/?url=example.org"
            target="_blank">
            Share on Pinterest
          </a>
  ...
  return (
    <div className="productOverviewContainer">
      ...
      <div className="overviewCenter">
        ...
        <div className="">
          <a
            href="https://www.youtube.com/watch?v=KBsUODDDODU"
            target="_blank">
